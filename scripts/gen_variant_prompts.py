...
AGENTS = {
    ...
    "write_chapter.md": "chapter_writer",
...
GUIDANCE = {
    "government_procurement": {
        ...
        "chapter_writer": "采用正式、审慎、政务采购口径，避免商业化夸张表达，对证据不足内容使用拟响应/按要求提交等保守表述。",
    ...
    "software_project": {
        ...
        "chapter_writer": "更强调功能拆解、架构设计、实施步骤、测试验收和技术可落地性，避免空泛服务话术。",
    ...
    "ops_service": {
        ...
        "chapter_writer": "更强调服务流程、响应机制、SLA 指标、值守安排、故障闭环和持续保障。",
    ...
    "system_integration": {
        ...
        "chapter_writer": "更强调系统边界、接口协同、软硬件集成、部署联调、风险控制和交付责任分工。",
