# 标书 Agent 流程逻辑 V1（已废弃历史架构）

> 版本：V1  
> 状态：已废弃 / 仅供迁移取证
> 冻结日期：2026-07-21  
> 版本导航：[current_logic_flow.md](./current_logic_flow.md)  
> 目标架构：[current_logic_flow_v2.md](./current_logic_flow_v2.md)

本文档记录旧工作流、Agent 编排、状态文件、材料清单和质量门禁的历史行为。自 2026-07-23 起，V1 不再是运行时真相源，不接受缺陷修复或兼容维护；仅允许受控迁移与取证读取其旧文件。
