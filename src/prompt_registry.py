...
AGENT_SPECS: dict[str, AgentSpec] = {
    ...
    "outline_generator": AgentSpec(
        ...
        version="1.0.0",
        input_contract={"documents": ["inputs/tender.md", "workspace/score_points.json", "workspace/global_facts.json", "workspace/template_evidence_map.json"], "mode": "outline_generate"},
    ...
    "chapter_context_selector": AgentSpec(
        ...
        version="1.0.0",
        input_contract={"documents": ["workspace/jobs/*.json", "workspace/chunks/tender_chunks.json", "workspace/chunks/company_chunks.json"], "mode": "context_select"},
    ...
    "chapter_writer": AgentSpec(
        ...
        version="1.0.0",
        input_contract={"documents": ["workspace/jobs/*.json", "workspace/contexts/*_context.json", "workspace/global_facts.json", "workspace/tender_requirements.json"], "mode": "chapter_write"},
